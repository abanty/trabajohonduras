...
switch ($_GET["op"]){
    ...
    $idprograma == null ? $idprograma='1' : $idprograma;
      ...
      if ($variable_factura && $contabilidad){
        ...
        str_replace(',','',$subtotalinicial),str_replace(',','',$descuentototal),$subtotal,str_replace(',','',$impuestosv),$tasaimpuestosv,str_replace(',','',$valor_sv),str_replace(',','',$impuesto),$tasaimpuesto,str_replace(',','',$valor_impuesto),$monto_total,str_replace(',','',$retencionisv),
