...
Class Retenciones
{
	...
	$imp_retenido,$total_oc,$idcompromisos,$valorbase)
	{
		...
		{
			$sql_detalle = "INSERT INTO detalle_retenciones(idretenciones,idcompromisos,valorbase)
			VALUES ('$idingresonew','$idcompromisos[$num_elementos]','$valorbase[$num_elementos])";
