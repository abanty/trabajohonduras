...
{
	bootbox.confirm("¿Está Seguro de desactivar el programa?", function(result){
		if(result)
        {
...
{
	bootbox.confirm("¿Está Seguro de activar el programa?", function(result){
		if(result)
        {
