...
$pdf->Cell(40,6,'',0,0,'C');
$pdf->Cell(100,6,'FUERZA NAVAL DE HONDURAS',1,0,'C');
$pdf->Cell(100,6,'PAGADURIA GENERAL',1,0,'C');
$pdf->Cell(100,6,'CONSOLIDADO GENERAL DE EJECUCION PRESUPUESTARIA',1,0,'C');
$pdf->Ln(10);
