...
function addSociete( $tittle1, $tittle2,$tittle3,$tittle4 )
{
	...
	$this->SetXY( $x1+48, $y1 + 15 );
	$this->SetFont('Arial','B',11);
	// $length = $this->GetStringWidth( $tittle4 );
	$this->Cell( $length, 10, $tittle4);
...
function addClientAdresse( $cliente,$domicilio,$proveedor )
{
	...
	$this->MultiCell( 160,4, utf8_decode('SEÑOR'."\n".'COMANDANTE GENERAL F.N.H'
	."\n".'CONTRALMIRANTE'
	."\n".'EFRAIN MANN HERNANDEZ'."\n".''."\n".'ATENTAMENTE SOLICITO A UD ORDENE A QUIEN CORRESPONDA EL PAGO CORRESPONDIENTE POR'
	."\n".'SUMINISTROS A ESTA FUERZA, CARGANDO SU VALOR AL PROGRAMA: 90-11-03-01'
	."\n".''
	."\n".'COTIZADO AL SEÑOR :  '.strtoupper($proveedor)),0);
