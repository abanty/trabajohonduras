...
<!--Contenido-->
      ...
      <div class="content-wrapper">        
        ...
        <section class="content-header">
          <h1> 
            Ingreso de Compra de Combustibles y Lubricantes
          </h1>
          <ol class="breadcrumb">
            <li><a href="escritorio.php"><i class="fa fa-tachometer-alt"></i> Inicio</a></li>
            <li class="active">Administrar Combustibles</li>
          </ol>
        </section>
                        ...
                        <form name="formulario" id="formulario" method="POST">
                          ...
                          <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <a data-toggle="modal" href="#myModal">           
                              <button id="btnAgregarArt" type="button" class="btn btn-primary"> <span class="fas fa-cart-plus"></span>Agregar Compra</button>
                            </a>
                          </div>
